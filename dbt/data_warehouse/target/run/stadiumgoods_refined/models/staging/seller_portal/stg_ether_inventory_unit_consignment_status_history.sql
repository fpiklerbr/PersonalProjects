    ...
    merge into `ff-stadiumgoods-refined-live`.`stadiumgoods_staging`.`stg_ether_inventory_unit_consignment_status_history` as DBT_INTERNAL_DEST
        using (
