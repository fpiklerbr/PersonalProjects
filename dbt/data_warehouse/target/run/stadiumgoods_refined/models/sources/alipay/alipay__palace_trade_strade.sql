  ...
  create or replace view `ff-stadiumgoods-refined-live`.`stadiumgoods_sources`.`alipay__palace_trade_strade`
  OPTIONS()
  as 
...
FROM `ff-stadiumgoods-raw-live`.`imports`.`tmall_palace_trade_strade` AS source_table
