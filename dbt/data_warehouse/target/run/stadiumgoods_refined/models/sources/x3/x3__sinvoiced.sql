  ...
  create or replace view `ff-stadiumgoods-refined-dev`.`stadiumgoods_sources`.`x3__sinvoiced`
  OPTIONS()
  as 
...
SELECT   `updtick_0`,  `invoice_id`,  `invoice_line`,  `cpy_0`,  `x3_order_id`,  `x3_order_line`,  `soqseq_0`,  `sdhnum_0`,  `sddlin_0`,  `connum_0`,  `srenum_0`,  `sghnum_0`,  `original_invoice_id`,  `original_invoice_line`,  `return_id`,  `return_line`,  `pidlin_0`,  `bpcinv_0`,  `itmref_0`,  `itmdes1_0`,  `itmdes_0`,  `vacitm_0`,  `vacitm_1`,  `vacitm_2`,  `rep1_0`,  `rep2_0`,  `reprat1_0`,  `reprat2_0`,  `repbas1_0`,  `repbas2_0`,  `repamt1_0`,  `repamt2_0`,  `repcoe_0`,  `price`,  `priren_0`,  `netpri_0`,  `price_excluding_tax`,  `price_including_tax`,  `pfm_0`,  `cprpri_0`,  `discount`,  `gift_card`,  `shipping`,  `tax`,  `discrgval5_0`,  `discrgval6_0`,  `discrgval7_0`,  `discrgval8_0`,  `discrgval9_0`,  `discrgren1_0`,  `discrgren2_0`,  `discrgren3_0`,  `discrgren4_0`,  `discrgren5_0`,  `discrgren6_0`,  `discrgren7_0`,  `discrgren8_0`,  `discrgren9_0`,  `vat_0`,  `vat_1`,  `vat_2`,  `amtlin_0`,  `amtnotlin_0`,  `clcamt1_0`,  `clcamt2_0`,  `bastaxlin_0`,  `bastaxlin_1`,  `bastaxlin_2`,  `bastaxlin_3`,  `bastaxlin_4`,  `bastaxlin_5`,  `rattaxlin_0`,  `amttaxlin_0`,  `amttaxlin_1`,  `amttaxlin_2`,  `amtatilin_0`,  `dsplinflg_0`,  `ddtanum_0`,  `ddtanum_1`,  `ddtanum_2`,  `ddtanum_3`,  `ddtanum_4`,  `ddtanum_5`,  `ddtanum_6`,  `ddtanum_7`,  `ddtanum_8`,  `ddtanot_0`,  `ddtanot_1`,  `ddtanot_2`,  `ddtanot_3`,  `ddtanot_4`,  `ddtanot_5`,  `ddtanot_6`,  `ddtanot_7`,  `ddtanot_8`,  `qty_0`,  `qtystu_0`,  `sau_0`,  `stu_0`,  `saustucoe_0`,  `stofcy_0`,  `stomgtcod_0`,  `lot_0`,  `sta_0`,  `loc_0`,  `priord_0`,  `alltyp_0`,  `salfcy_0`,  `invdat_0`,  `tsicod_0`,  `tsicod_1`,  `tsicod_2`,  `tsicod_3`,  `tsicod_4`,  `lintyp_0`,  `focflg_0`,  `orilin_0`,  `sidtex_0`,  `lineecflg_0`,  `eecflophy_0`,  `geocod_0`,  `insctyflg_0`,  `vts_0`,  `vtc_0`,  `taxgeoflg_0`,  `taxflg_0`,  `taxregflg_0`,  `invprnbom_0`,  `strdat_0`,  `enddat_0`,  `pernbr_0`,  `pertyp_0`,  `pitflg_0`,  `dsplinwei_0`,  `dsplinvol_0`,  `dspweu_0`,  `dspvou_0`,  `wrh_0`,  `expnum_0`,  `impnumlig_0`,  `creusr_0`,  `credat_0`,  `updusr_0`,  `upddat_0`,  `created_at`,  `updated_at`,  `auuid_0`,  `rowid`
...
SELECT
 ...
 AS `srenum_0`
  ...
  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`sghnum_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`sghnum_0` AS string)), '') AS string) END as string)
 AS `sghnum_0`
 ...
 AS `original_invoice_id`
  ...
  , 
    safe_cast(
    safe_cast(CASE WHEN cast(nullif(trim(cast(`sidorilin_0` AS string)), '') AS string) IN ('0','0.0','0.000','0.0000','0.00000','0.00000000','nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`sidorilin_0` AS string)), '') AS string) END as float64)
 as int64)
 AS `original_invoice_line`
 ...
 AS `return_id`
  ...
  , 
    safe_cast(
    safe_cast(CASE WHEN cast(nullif(trim(cast(`srdlin_0` AS string)), '') AS string) IN ('0','0.0','0.000','0.0000','0.00000','0.00000000','nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`srdlin_0` AS string)), '') AS string) END as float64)
 as int64)
 AS `return_line`
 ...
 AS `reprat2_0`
  ...
  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`repbas1_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`repbas1_0` AS string)), '') AS string) END as numeric)
 AS `repbas1_0`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`repbas2_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`repbas2_0` AS string)), '') AS string) END as numeric)
 AS `repbas2_0`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`repamt1_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`repamt1_0` AS string)), '') AS string) END as numeric)
 AS `repamt1_0`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`repamt2_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`repamt2_0` AS string)), '') AS string) END as numeric)
 AS `repamt2_0`
 ...
 AS `bastaxlin_0`
  ...
  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`bastaxlin_1` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`bastaxlin_1` AS string)), '') AS string) END as numeric)
 AS `bastaxlin_1`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`bastaxlin_2` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`bastaxlin_2` AS string)), '') AS string) END as numeric)
 AS `bastaxlin_2`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`bastaxlin_3` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`bastaxlin_3` AS string)), '') AS string) END as numeric)
 AS `bastaxlin_3`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`bastaxlin_4` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`bastaxlin_4` AS string)), '') AS string) END as numeric)
 AS `bastaxlin_4`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`bastaxlin_5` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`bastaxlin_5` AS string)), '') AS string) END as numeric)
 AS `bastaxlin_5`
 ...
 AS `rattaxlin_0`
  ...
  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`amttaxlin_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`amttaxlin_0` AS string)), '') AS string) END as numeric)
 AS `amttaxlin_0`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`amttaxlin_1` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`amttaxlin_1` AS string)), '') AS string) END as numeric)
 AS `amttaxlin_1`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`amttaxlin_2` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`amttaxlin_2` AS string)), '') AS string) END as numeric)
 AS `amttaxlin_2`
 ...
 AS `orilin_0`
  ...
  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`sidtex_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`sidtex_0` AS string)), '') AS string) END as string)
 AS `sidtex_0`
...
FROM `ff-stadiumgoods-raw-live`.`live`.`sinvoiced` AS source_table
