  ...
  create or replace view `ff-stadiumgoods-refined-dev`.`stadiumgoods_sources`.`x3__sinvoicev`
  OPTIONS()
  as 
...
SELECT
 ...
 AS `invtyp_0`
  ...
  , 
    safe_cast(
    safe_cast(CASE WHEN cast(nullif(trim(cast(`sihori_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`sihori_0` AS string)), '') AS string) END as float64)
 as int64)
 AS `sihori_0`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`sihorinum_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`sihorinum_0` AS string)), '') AS string) END as string)
 AS `sihorinum_0`

  , 
    safe_cast(
    safe_cast(CASE WHEN cast(nullif(trim(cast(`sihoridat_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`sihoridat_0` AS string)), '') AS string) END as timestamp)
 as datetime)
 AS `sihoridat_0`

  , 
    safe_cast(
    safe_cast(CASE WHEN cast(nullif(trim(cast(`invdat_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`invdat_0` AS string)), '') AS string) END as timestamp)
 as datetime)
 AS `invdat_0`
 ...
 AS `invoice_status_code`
  ...
  , 
    safe_cast(
    safe_cast(CASE WHEN cast(nullif(trim(cast(`invcnosta_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`invcnosta_0` AS string)), '') AS string) END as float64)
 as int64)
 AS `invcnosta_0`

  , 
    safe_cast(
    safe_cast(CASE WHEN cast(nullif(trim(cast(`stomvtflg_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`stomvtflg_0` AS string)), '') AS string) END as float64)
 as int64)
 AS `stomvtflg_0`
 ...
 AS `rep_1`
  ...
  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`cnoren_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`cnoren_0` AS string)), '') AS string) END as string)
 AS `cnoren_0`
 ...
 AS `tsccod_4`
  ...
  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`sihtex1_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`sihtex1_0` AS string)), '') AS string) END as string)
 AS `sihtex1_0`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`sihtex2_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`sihtex2_0` AS string)), '') AS string) END as string)
 AS `sihtex2_0`
 ...
 AS `orifcy_0`
  ...
  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`pihnum_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`pihnum_0` AS string)), '') AS string) END as string)
 AS `pihnum_0`
 ...
 AS `pam_0`
  ...
  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`pam_1` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`pam_1` AS string)), '') AS string) END as string)
 AS `pam_1`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`pam_2` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`pam_2` AS string)), '') AS string) END as string)
 AS `pam_2`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`pam_3` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`pam_3` AS string)), '') AS string) END as string)
 AS `pam_3`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`insati_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`insati_0` AS string)), '') AS string) END as numeric)
 AS `insati_0`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`insati_1` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`insati_1` AS string)), '') AS string) END as numeric)
 AS `insati_1`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`insati_2` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`insati_2` AS string)), '') AS string) END as numeric)
 AS `insati_2`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`insati_3` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`insati_3` AS string)), '') AS string) END as numeric)
 AS `insati_3`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`insordnum_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`insordnum_0` AS string)), '') AS string) END as string)
 AS `insordnum_0`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`insordnum_1` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`insordnum_1` AS string)), '') AS string) END as string)
 AS `insordnum_1`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`insordnum_2` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`insordnum_2` AS string)), '') AS string) END as string)
 AS `insordnum_2`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`insordnum_3` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`insordnum_3` AS string)), '') AS string) END as string)
 AS `insordnum_3`

  , 
    safe_cast(
    safe_cast(CASE WHEN cast(nullif(trim(cast(`inslin_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`inslin_0` AS string)), '') AS string) END as float64)
 as int64)
 AS `inslin_0`

  , 
    safe_cast(
    safe_cast(CASE WHEN cast(nullif(trim(cast(`inslin_1` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`inslin_1` AS string)), '') AS string) END as float64)
 as int64)
 AS `inslin_1`

  , 
    safe_cast(
    safe_cast(CASE WHEN cast(nullif(trim(cast(`inslin_2` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`inslin_2` AS string)), '') AS string) END as float64)
 as int64)
 AS `inslin_2`

  , 
    safe_cast(
    safe_cast(CASE WHEN cast(nullif(trim(cast(`inslin_3` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`inslin_3` AS string)), '') AS string) END as float64)
 as int64)
 AS `inslin_3`
 ...
 AS `copnbr_0`
  ...
  , 
    safe_cast(
    safe_cast(CASE WHEN cast(nullif(trim(cast(`copnbe_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`copnbe_0` AS string)), '') AS string) END as float64)
 as int64)
 AS `copnbe_0`
 ...
 AS `entcod_0`
  ...
  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`srglocdef_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`srglocdef_0` AS string)), '') AS string) END as string)
 AS `srglocdef_0`
 ...
 AS `eecnat_0`
  ...
  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`eecnatr_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`eecnatr_0` AS string)), '') AS string) END as string)
 AS `eecnatr_0`
 ...
 AS `eecsch_0`
  ...
  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`eecschr_0` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`eecschr_0` AS string)), '') AS string) END as string)
 AS `eecschr_0`
...
FROM `ff-stadiumgoods-raw-live`.`live`.`sinvoicev` AS source_table
