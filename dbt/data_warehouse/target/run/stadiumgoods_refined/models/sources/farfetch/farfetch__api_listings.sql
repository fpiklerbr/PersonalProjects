    ...
    merge into `ff-stadiumgoods-refined-live`.`stadiumgoods_sources`.`farfetch__api_listings` as DBT_INTERNAL_DEST
        using (
...
WHERE 
 ...
 > (SELECT max(file_time) FROM `ff-stadiumgoods-refined-live`.`stadiumgoods_sources`.`farfetch__api_listings` )
    ...
    when not matched then insert
        (`row_order`, `id`, `style`, `store_barcode`, `size_range_type`, `size`, `season_id`, `season`, `sku`, `quantity`, `name`, `item_id`, `group`, `gender_id`, `gender`, `full_price`, `discount_price`, `department`, `brand`, `barcode`, `file_name`, `file_time`, `fps_stock_point_id`)
    values
        (`row_order`, `id`, `style`, `store_barcode`, `size_range_type`, `size`, `season_id`, `season`, `sku`, `quantity`, `name`, `item_id`, `group`, `gender_id`, `gender`, `full_price`, `discount_price`, `department`, `brand`, `barcode`, `file_name`, `file_time`, `fps_stock_point_id`)
