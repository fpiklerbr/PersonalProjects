  ...
  create or replace view `ff-stadiumgoods-refined-live`.`stadiumgoods_sources`.`seller_portal__ether_pim_product_colors`
  OPTIONS()
  as 
...
WHERE 1=1
    ...
    `ether_pim_product_color_id` AS `ether_pim_product_color_id`
