  ...
  create or replace view `ff-stadiumgoods-refined-live`.`stadiumgoods_sources`.`seller_portal__ether_pim_product_brands`
  OPTIONS()
  as 
...
FROM `ff-stadiumgoods-raw-live`.`stadium_goods_production`.`product_brands`
