    ...
    merge into `ff-stadiumgoods-refined-live`.`stadiumgoods_sources`.`sales_channel__fps_catalog_parity_snapshot_pdt_var` as DBT_INTERNAL_DEST
        using (
...
WHERE 1=1
    ...
    when not matched then insert
        (`fps_catalog_parity_snapshot_product_variant_id`, `fps_catalog_parity_snapshot_product_id`, `sg_size`, `sg_price_in_dollars`, `fps_size`, `fps_price_in_dollars`, `fps_merchant_id`, `size_mapping_status`, `global_on_hand_inv_price`, `dss_merchants_on_hand_inventory`, `ff_variant_id`, `global_on_hand_inventory`, `dss_merchants_on_hand_inv_price`, `sg_merchants_on_hand_inv_price`, `sg_merchants_on_hand_inventory`, `_synched_from_source_at`)
    values
        (`fps_catalog_parity_snapshot_product_variant_id`, `fps_catalog_parity_snapshot_product_id`, `sg_size`, `sg_price_in_dollars`, `fps_size`, `fps_price_in_dollars`, `fps_merchant_id`, `size_mapping_status`, `global_on_hand_inv_price`, `dss_merchants_on_hand_inventory`, `ff_variant_id`, `global_on_hand_inventory`, `dss_merchants_on_hand_inv_price`, `sg_merchants_on_hand_inv_price`, `sg_merchants_on_hand_inventory`, `_synched_from_source_at`)
