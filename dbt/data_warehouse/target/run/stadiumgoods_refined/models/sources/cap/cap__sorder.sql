  ...
  create or replace view `ff-stadiumgoods-refined-live`.`stadiumgoods_sources`.`cap__sorder`
  OPTIONS()
  as 
...
SELECT
 ...
 AS `release_flag`
  ...
  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`reship850flag` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`reship850flag` AS string)), '') AS string) END as string)
 AS `reship850flag`
 ...
 AS `capacity_import_id`
  ...
  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`ponumber` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`ponumber` AS string)), '') AS string) END as string)
 AS `ponumber`
 ...
 AS `shipping_amount`
  ...
  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`shipping_tax_rate` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`shipping_tax_rate` AS string)), '') AS string) END as float64)
 AS `shipping_tax_rate`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`order_discount_rate` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`order_discount_rate` AS string)), '') AS string) END as float64)
 AS `order_discount_rate`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`order_discount_amount` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`order_discount_amount` AS string)), '') AS string) END as float64)
 ...
 AS `item_product_id`
  ...
  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`item_unit_amount` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`item_unit_amount` AS string)), '') AS string) END as float64)
 AS `item_unit_amount`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`item_discount_rate` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`item_discount_rate` AS string)), '') AS string) END as float64)
 AS `item_discount_rate`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`item_tax_rate` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`item_tax_rate` AS string)), '') AS string) END as float64)
 AS `item_tax_rate`

  , 
    safe_cast(
    safe_cast(CASE WHEN cast(nullif(trim(cast(`item_order_quantity` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`item_order_quantity` AS string)), '') AS string) END as float64)
 as int64)
 ...
 AS `item_product_desc`
  ...
  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`codflag` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`codflag` AS string)), '') AS string) END as string)
 AS `codflag`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`codamount` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`codamount` AS string)), '') AS string) END as string)
 AS `codamount`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`codadd_ship_charges` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`codadd_ship_charges` AS string)), '') AS string) END as string)
 AS `codadd_ship_charges`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`codcashier_check` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`codcashier_check` AS string)), '') AS string) END as string)
 AS `codcashier_check`
 ...
 AS `end_of_line`
  ...
  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`sorder_file` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`sorder_file` AS string)), '') AS string) END as string)
 AS `file_name`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`sorder_timestamp` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`sorder_timestamp` AS string)), '') AS string) END as timestamp)
 AS `file_time`
 ...
 AS `cod_cashier_check`
  ...
  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`unnamed_67` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`unnamed_67` AS string)), '') AS string) END as string)
 AS `unnamed_67`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`ship_address1_1` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`ship_address1_1` AS string)), '') AS string) END as string)
 AS `ship_address1_1`

  , 
    safe_cast(CASE WHEN cast(nullif(trim(cast(`ship_address2_1` AS string)), '') AS string) IN ('nan','None','','NaT') THEN NULL ELSE cast(nullif(trim(cast(`ship_address2_1` AS string)), '') AS string) END as string)
 AS `ship_address2_1`



FROM `ff-stadiumgoods-raw-live`.`imports`.`cap_sorder` AS source_table
