  ...
  create or replace view `ff-stadiumgoods-refined-live`.`stadiumgoods_sources`.`magento__catalog_category_entity_int`
  OPTIONS()
  as 
...
FROM `ff-stadiumgoods-raw-live`.`stadium_production`.`catalog_category_entity_int` AS source_table
