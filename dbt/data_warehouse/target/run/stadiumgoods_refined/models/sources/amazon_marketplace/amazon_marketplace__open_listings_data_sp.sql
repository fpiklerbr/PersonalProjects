    ...
    merge into `ff-stadiumgoods-refined-live`.`stadiumgoods_sources`.`amazon_marketplace__open_listings_data_sp` as DBT_INTERNAL_DEST
        using (
...
FROM `ff-stadiumgoods-raw-live`.`imports`.`amazon_open_listings_data_sp` AS source_table

WHERE 
    safe_cast(file_time as timestamp)
 > (SELECT max(file_time) FROM `ff-stadiumgoods-refined-live`.`stadiumgoods_sources`.`amazon_marketplace__open_listings_data_sp` )
    ...
    when not matched then insert
        (`sku`, `asin`, `price`, `quantity`, `file_name`, `file_time`, `region`, `_raw_business_price`, `_raw_quantity_price_type`, `_raw_quantity_lower_bound_1`, `_raw_quantity_price_1`, `_raw_quantity_lower_bound_2`, `_raw_quantity_price_2`, `_raw_quantity_lower_bound_3`, `_raw_quantity_price_3`, `_raw_quantity_lower_bound_4`, `_raw_quantity_price_4`, `_raw_quantity_lower_bound_5`, `_raw_quantity_price_5`, `_raw_progressive_price_type`, `_raw_progressive_lower_bound_1`, `_raw_progressive_price_1`, `_raw_progressive_lower_bound_2`, `_raw_progressive_price_2`, `_raw_progressive_lower_bound_3`, `_raw_progressive_price_3`)
    values
        (`sku`, `asin`, `price`, `quantity`, `file_name`, `file_time`, `region`, `_raw_business_price`, `_raw_quantity_price_type`, `_raw_quantity_lower_bound_1`, `_raw_quantity_price_1`, `_raw_quantity_lower_bound_2`, `_raw_quantity_price_2`, `_raw_quantity_lower_bound_3`, `_raw_quantity_price_3`, `_raw_quantity_lower_bound_4`, `_raw_quantity_price_4`, `_raw_quantity_lower_bound_5`, `_raw_quantity_price_5`, `_raw_progressive_price_type`, `_raw_progressive_lower_bound_1`, `_raw_progressive_price_1`, `_raw_progressive_lower_bound_2`, `_raw_progressive_price_2`, `_raw_progressive_lower_bound_3`, `_raw_progressive_price_3`)
